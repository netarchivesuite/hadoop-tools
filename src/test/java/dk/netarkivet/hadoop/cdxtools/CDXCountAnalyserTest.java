 ...
 */
@Ignore
public class CDXCountAnalyserTest {
   ...
   @Before
   public void setUp() {
      CDXCountAnalyser.ArchiveFilenameCountMapper mapper = new CDXCountAnalyser.ArchiveFilenameCountMapper();
      CDXCountAnalyser.WordCountReducer reducer = new CDXCountAnalyser.WordCountReducer();
